...
export const mockRiskParameters: RiskParameter[] = [
  {
    ...
    description:
      "Risk associated with countries known for high financial crime.",
    riskLevel: "High",
    score: 85,
    status: "Active",
    version: 1,
...
export const mockAssessments: CustomerRiskAssessment[] = [
  {
    ...
    breakdown: [
      {
        parameterName: "Geographic Risk",
        score: 20,
        weight: 40,
        weightedScore: 8,
      },
      {
        parameterName: "Product Risk",
        score: 50,
        weight: 30,
        weightedScore: 15,
      },
      {
        parameterName: "Segment Risk",
        score: 73,
        weight: 30,
        weightedScore: 22,
      },
    ],
    history: [{ date: "2023-03-10T14:30:00Z", score: 42, rating: "Medium" }],
  },
  {
    id: "as-1002",
    customerId: "C-77421",
  ...
  },
  {
    ...
    history: [{ date: "2023-09-14T11:45:00Z", score: 85, rating: "Very High" }],
  },
];
...
export const mockWorkflows: Workflow[] = [
  ...
  },
  {
    ...
    escalationTime: 24,
    status: "Active",
    steps: [{ level: 1, role: "Risk Manager" }],
  },
];
