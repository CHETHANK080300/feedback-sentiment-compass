...
const apps = [
  { name: "Retail Banking", score: 78, feedback: 4500, rating: 4.2, issues: 5 },
  {
  ...
  { name: "Wealth Banking", score: 85, feedback: 850, rating: 4.4, issues: 2 },
];
        ...
        {apps.map((app) => (
          ...
          >
            <div className="space-y-3">
              ...
              <button className="w-full mt-2 rounded-lg border border-border bg-muted/30 py-2 text-xs font-medium hover:bg-muted/50 transition-colors">
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {modules.map((m) => (
            <div
              key={m.name}
              className="relative group overflow-hidden rounded-xl border border-border p-4 hover:border-primary/40 transition-all"
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-sm font-semibold">{m.complaints}</div>
                </div>
                <div>
                  <div className="text-[10px] uppercase text-muted-foreground">
                    Rating
              ...
              >
                <span className="flex items-center gap-1.5 text-xs font-semibold text-primary bg-background px-3 py-1.5 rounded-full shadow-lg">
